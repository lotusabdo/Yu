...
async def play(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("𝖱𝖾𝗌𝗎𝗆𝖾", callback_data=f"resume"),
        InlineKeyboardButton("𝖯𝖺𝗎𝗌𝖾", callback_data=f"pause"),
        InlineKeyboardButton("𝖲𝖪𝖨𝖯", callback_data="skip"),
        InlineKeyboardButton("𝖤𝖭𝖣", callback_data="end")],
        [InlineKeyboardButton("◜𝐕 𝐎 𝐃 𝐈 𝐊 𝐀◞", url=f"https://t.me/YwYvYe")],
...
🎧 **بواسطه:** {ruser}
        ...
        try:
            ...
            if 'CreateGroupCall' in str(e):
                ...
                return await dream.edit_text(f"{e}\n✯ في حاله ظهور لك مثل هذه المشكله تواصل مع المطور -> @YwYvYe")
    ...
    if admin(msg):
        ...
        if command == "/pause":
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton("𝖱𝖾𝗌𝗎𝗆𝖾", callback_data=f"resume"),
                InlineKeyboardButton("𝖯𝖺𝗎𝗌𝖾", callback_data=f"pause"),
                InlineKeyboardButton("𝖲𝖪𝖨𝖯", callback_data=f"skip"),
                InlineKeyboardButton("𝖤𝖭𝖣", callback_data=f"end")],
                [InlineKeyboardButton("◜𝐕 𝐎 𝐃 𝐈 𝐊 𝐀◞", url="https://t.me/YwYvYe")],
