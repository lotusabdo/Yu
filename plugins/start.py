...
🔰╜ للدخول لقناة السورس [دوس هنا](https://t.me/l2_2Y)"""
        ...
        await m.reply_text("مرحبا! أنا لوتس. لاكتشاف وظائفي ، ابدأ محادثة معي.", reply_markup=keyboard)
...
async def start(c: Client, m: Message):
    await confirm_user(c, m)
    if m.chat.type == enums.ChatType.PRIVATE:
        botname = get_db_botname() or "لوتس"
        x = f"""
